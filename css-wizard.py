...
class GetHomepageWizard:
    def __init__(self, root):
        self.root = root
        self.root.title(f"Gethomepage CSS Wizard v{VERSION}")
        try:
    ...
    def create_version_label(self):
        version_label = ttk.Label(self.root, text=f"v{VERSION}", foreground='gray')
    ...
    def generate_css(self):
        css_parts = [f"/* Generated by Gethomepage CSS Wizard v{VERSION} */"]
        css_parts.append("")
